 ...
 * Include this file + call initNotifications() to use showToast() and showConfirm() anywhere.
 */
...
(function() {
    ...
    if (!document.getElementById('ui-notif-styles')) {
        ...
        style.textContent = `
            .toast-container { position: fixed; top: 1.5rem; right: 1.5rem; z-index: 100000; display: flex; flex-direction: column; gap: 0.5rem; pointer-events: none; }
            .toast { padding: 0.85rem 1.25rem; border-radius: 10px; color: #fff; font-size: 0.9rem; box-shadow: 0 4px 15px rgba(0,0,0,0.2); animation: toastIn 0.3s ease; max-width: 400px; line-height: 1.4; pointer-events: auto; }
