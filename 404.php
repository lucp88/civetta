...
<head>
    ...
    <title>Pagina niet gevonden — Bakkerij Civetta</title>
    ...
    <main>
        <section class="error-section">
            <div>
                ...
                <p>De pagina die je zoekt is niet gevonden. Misschien is deze verplaatst of verwijderd.</p>
                <div class="error-actions">
                    <a href="/" class="btn">Naar de homepage</a>
                    <a href="/producten.html" class="btn btn-outline">Bekijk onze producten</a>
