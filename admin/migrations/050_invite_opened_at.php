...
<body>
<div class="card">
<h1>Migration 050: Uitnodiging geopend</h1>
<pre><?php

try {
    $pdo->exec("ALTER TABLE business_accounts ADD COLUMN invite_opened_at DATETIME NULL DEFAULT NULL AFTER invite_token");
    echo "<span class='success'>✓ Kolom invite_opened_at toegevoegd</span>\n";
} catch (PDOException $e) {
    if (strpos($e->getMessage(), 'Duplicate column') !== false) {
        echo "<span class='info'>- invite_opened_at bestaat al</span>\n";
    } else {
        echo "<span class='error'>✗ " . htmlspecialchars($e->getMessage()) . "</span>\n";
    }
}

echo "\n<span class='success'>✓ Migration 050 voltooid!</span>\n";
?></pre>

<p><strong>Wijzigingen:</strong></p>
<ul>
    <li><code>invite_opened_at</code> (DATETIME) — tijdstip waarop de klant de uitnodigingslink voor het eerst opende</li>
</ul>
