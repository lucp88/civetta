...
<body>
<div class="card">
<h1>Migration 063: Sourdough consumed flag</h1>
<pre><?php
try {
    $pdo->exec("ALTER TABLE bak_acties ADD COLUMN sourdough_consumed TINYINT(1) NOT NULL DEFAULT 0 AFTER inventory_consumed");
    echo "<span class='success'>✓ Kolom sourdough_consumed toegevoegd aan bak_acties</span>\n";
} catch (PDOException $e) {
    if (str_contains($e->getMessage(), 'Duplicate column')) {
        echo "<span class='info'>- sourdough_consumed bestaat al</span>\n";
    } else {
        echo "<span class='error'>✗ " . htmlspecialchars($e->getMessage()) . "</span>\n";
    }
}

echo "\n<span class='success'>✓ Migration 063 voltooid!</span>\n";
?></pre>

<p><strong>Wijzigingen:</strong></p>
<ul>
    <li>Kolom <code>sourdough_consumed</code> toegevoegd aan <code>bak_acties</code> — bijhouden of desemmeel al is afgeschreven</li>
</ul>
