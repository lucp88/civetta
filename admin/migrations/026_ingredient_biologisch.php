...
<body>
<div class="card">
<h1>Migration 026: Ingredient biologisch</h1>
<pre><?php

try {
    $pdo->exec("ALTER TABLE ingredients ADD COLUMN is_biologisch TINYINT(1) NOT NULL DEFAULT 0 AFTER is_whole_grain");
    echo "<span class='success'>✓ is_biologisch kolom toegevoegd aan ingredients</span>\n";
} catch (PDOException $e) {
    echo strpos($e->getMessage(), 'Duplicate') !== false
        ? "<span class='info'>- is_biologisch kolom bestaat al</span>\n"
        : "<span class='error'>✗ " . htmlspecialchars($e->getMessage()) . "</span>\n";
}

echo "\n<span class='success'>✓ Migration 026 voltooid!</span>\n";
?></pre>

<p><strong>Wijzigingen:</strong></p>
<ul>
    <li>ingredients: +is_biologisch (markeer ingrediënten als biologisch)</li>
</ul>
