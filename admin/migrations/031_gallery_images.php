...
<body>
<div class="card">
<h1>Migration 031: Gallery Images</h1>
<pre><?php
try {
    ...
    echo "<span class='success'>✓ gallery_images tabel aangemaakt</span>\n";
} catch (PDOException $e) {
    if (strpos($e->getMessage(), 'already exists') !== false) {
        echo "<span class='info'>- gallery_images tabel bestaat al</span>\n";
    } else {
        echo "<span class='error'>✗ " . htmlspecialchars($e->getMessage()) . "</span>\n";
    }
}

echo "\n<span class='success'>✓ Migration 031 voltooid!</span>\n";
?></pre>

<p><strong>Wijzigingen:</strong></p>
<ul>
    <li>Nieuwe tabel gallery_images (id, filename, alt_text, sort_order, created_at)</li>
</ul>
