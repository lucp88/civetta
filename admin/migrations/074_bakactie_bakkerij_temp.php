...
<body>
<div class="card">
<h1>Migration 074: Bakkerij temperatuur in bakactie</h1>
<pre><?php

try {
    $pdo->exec("ALTER TABLE bak_acties ADD COLUMN bakkerij_temp DECIMAL(4,1) NULL DEFAULT NULL AFTER dough_temp");
    echo "<span class='success'>✓ Kolom bakkerij_temp toegevoegd aan bak_acties</span>\n";
} catch (PDOException $e) {
    if (strpos($e->getMessage(), 'Duplicate column') !== false)
        echo "<span class='info'>- bakkerij_temp bestaat al</span>\n";
    else
        echo "<span class='error'>✗ " . htmlspecialchars($e->getMessage()) . "</span>\n";
}

echo "\n<span class='success'>✓ Migration 074 voltooid!</span>\n";
?></pre>

<p><strong>Wijzigingen:</strong></p>
<ul>
    <li><code>bak_acties.bakkerij_temp</code> — kamertemperatuur van de bakkerij op het moment van bakken</li>
</ul>
