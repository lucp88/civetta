...
<body>
<div class="card">
<h1>Migration 066: Deeg gemaakt tijdstip</h1>
<pre><?php
try {
    $pdo->exec("ALTER TABLE bak_acties ADD COLUMN dough_mixed_at DATETIME NULL AFTER sourdough_fed_at");
    echo "<span class='success'>✓ Kolom dough_mixed_at toegevoegd</span>\n";
} catch (PDOException $e) {
    if (strpos($e->getMessage(), 'Duplicate column') !== false) {
        echo "<span class='info'>- dough_mixed_at bestaat al</span>\n";
    } else {
        echo "<span class='error'>✗ " . htmlspecialchars($e->getMessage()) . "</span>\n";
    }
}

echo "\n<span class='success'>✓ Migration 066 voltooid!</span>\n";
?></pre>

<p><strong>Wijzigingen:</strong></p>
<ul>
    <li>Kolom <code>dough_mixed_at</code> — tijdstip deeg gemaakt (voor meting desem-activiteit: gevoed → deeg gemaakt)</li>
</ul>
